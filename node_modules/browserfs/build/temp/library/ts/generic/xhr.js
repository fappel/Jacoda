 ...
 * @hidden
 */
export let asyncDownloadFile = asyncDownloadFileModern;
/**
 ...
 * @hidden
 */
export let syncDownloadFile = (isIE && typeof Blob !== 'undefined') ? syncDownloadFileIE10 : syncDownloadFileModern;
/**
 * Synchronously retrieves the size of the given file in bytes.
 * @hidden
 */
export function getFileSizeSync(p) {
    let rv = -1;
 ...
 * @hidden
 */
export function getFileSizeAsync(p, cb) {
