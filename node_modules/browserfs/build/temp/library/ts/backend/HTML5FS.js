...
export class HTML5FSFile extends PreloadFile {
 ...
 */
export default class HTML5FS extends BaseFileSystem {
    /**
     ...
     */
    constructor(size = 5, type = global.PERSISTENT, deprecateMsg = true) {
        super();
        // Convert MB to bytes.
