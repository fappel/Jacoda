...
import { arrayish2Buffer, copyingSlice, deprecationMessage, bufferValidator } from '../core/util';
import ExtendedASCII from '../generic/extended_ascii';
import setImmediate from '../generic/setImmediate';
/**
 * @hidden
 */
const inflateRaw = require('pako/lib/inflate').inflateRaw;
...
export default class ZipFS extends SynchronousFileSystem {
     ...
     */
    constructor(input, name = '', deprecateMsg = true) {
        super();
        this.name = name;
     ...
     */
    static computeIndex(data, cb, deprecateMsg = true) {
    ...
    static computeIndexResponsive(data, index, cdPtr, cdEnd, cb, cdEntries, eocd) {
        if (cdPtr < cdEnd) {
            let count = 0;
    ...
    populateIndex() {
        ...
        const cdEnd = cdPtr + eocd.cdSize();
        while (cdPtr < cdEnd) {
            const cd = new CentralDirectory(this.data, this.data.slice(cdPtr));
            cdPtr += cd.totalSize();
